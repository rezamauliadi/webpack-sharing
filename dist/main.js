...
// Module
exports.push([module.i, ".suatustyle {\n  background-color: aquamarine;\n  font-size: 24px;\n  padding: 60px;\n  font-weight: bold;\n  color: #333;\n}\n", ""]);
// Exports
...
function sumElement() {
  ...
  el.innerHTML = `Sum Function: ${Object(_calculations__WEBPACK_IMPORTED_MODULE_1__["default"])(4, 2323)}`;
  return el;
}

function imgElement() {
  const img = new Image();
  img.src = _webpack_png__WEBPACK_IMPORTED_MODULE_3__["default"];
  return img;
}
...
function component() {
  ...
  element.innerHTML = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.join(["Helloooooooooooo", "asflehwlfwe ufhwoueh"], " ");
